...
@app.route('/')
def home():
    return "🚀 ربات فروشگاهی روبیکا فعال است!"
...
if __name__ == '__main__':
    print("🚀 ربات فروشگاهی با Webhook شروع شد...")
    print(f"👤 ADMIN_ID: {ADMIN_ID}")
    print("⏳ در حال انتظار برای دریافت Webhook...")
